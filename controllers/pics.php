<?php class pics extends _base
{
    ...
    public function get_all()
    {
        ...
        if ($id_ref <= 0) {
            ...
            $this->rsp['items'] = $this->db->arr("SELECT *, DATE_FORMAT(date_added, '%d/%m/%Y') date_added FROM pics WHERE type = $type AND id_ref = $id_ref AND state = 1");
            $this->rsp['ok'] = true;
