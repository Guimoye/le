...
<div class="portlet light">
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            {if $can_incomes}
                <span class="btn btn-circle green btn-outline" onclick="MIncome.add();"> <i class="fa fa-plus"></i> Nuevo </span>
            {/if}
        </div>
    </div>
    ...
    <div class="portlet-body">
        ...
        {else}
            <table class="table table-striped table-bordered table-hover dt-responsivemdl-td">
                <thead>
                <tr>
                    <th width="1%"> # </th>
                    <th> Notas </th>
                ...
                {foreach key=i item=o from=$incomes}
                    <tr>
                        <td>{$o.id}</td>
                        <td>{$o.notes}</td>
                        <td>
                        ...
                        <td>
                            {if $can_incomes}
                                <span class="btn btn-outline btn-circle dark btn-sm" onclick="MIncome.edit(incomes[{$i}]);">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <input type="hidden" name="action" value="register_income">
...
<script>
    var incomes = {$incomes|@json_encode};
