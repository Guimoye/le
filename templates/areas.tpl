    ...
    <div class="col-md-6">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    {if $can_areas}
                        <span class="btn btn-circle green btn-outline" onclick="MArea.add();"> <i class="fa fa-plus"></i> Nuevo </span>
                    {/if}
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                {if empty($areas)}
                    <div class="alert alert-warning">
                        No se han añadido areas de producción.
                    </div>
                {else}
                    <table class="table table-striped table-bordered table-hover dt-responsive">
                        ...
                        {foreach key=i item=o from=$areas}
                            <tr>
                                ...
                                <td>
                                    {if $can_areas}
                                        <span class="btn btn-outline btn-circle dark btn-sm" onclick="MArea.edit(areas[{$i}]);">
